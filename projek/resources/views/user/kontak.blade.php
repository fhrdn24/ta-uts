...
<div class="site-section">
    ...
    <div class="row">
        <div class="col-md-12">
        <h2 class="h3 mb-3 text-black">Pesan Masuk</h2>
        </div>
        <div class="col-md-7">
       ...
       <span class="d-block text-primary h6 text-uppercase">Lokasi</span>
            <p class="mb-0">Indonesia</p>
        </div>
        <div class="p-4 border mb-3">
        <i class="fas fa-phone"></i>
            <span class="d-block text-primary h6 text-uppercase">Call Center</span>
            <p class="mb-0">081234567891</p>
        </div>
        <div class="p-4 border mb-3">
