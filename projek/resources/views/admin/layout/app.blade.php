...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{ asset('adminassets') }}/assets/images/logo/3.png" />
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="{{route('admin.dashboard')}}"><img src="{{ asset('adminassets') }}/assets/images/logo/3.1.png" alt="logo" style="width:100px; height:100px;" /></a>
        </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">D`Goyor</span>
